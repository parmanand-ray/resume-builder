  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10   rounded-full px-6 py-1.5">
        <Zap width={15} />
        <span>Trusted by 1000+ job seekers</span>
      </div>
      <Title
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600 max-w-xs">
                  Create job-winning resumes instantly using AI-powered
                  suggestions tailored for freshers and professionals.
                </p>
              </div>
            </div>
          </div>
          <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
            <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600 max-w-xs">
                  Professionally designed resume templates optimized for
                  Applicant Tracking Systems (ATS) to increase job selection
                  chances.
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
            <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600 max-w-xs">
                  Download resumes in PDF format or share directly with
                  recruiters in seconds—fast, simple, and efficient.
                </p>
              </div>
            </div>
          </div>
