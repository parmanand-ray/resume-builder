...
const Dashboard = () => {
  const colors = ["#9333ea", "#d97706", "#dc2626", "#0284c7", "#16a34a"]; // Define colors array
  ...
  const createResume = async (event) => {
    ...
    navigate("/app/builder/reume-123");
  };
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 sm:flex flex-wrap gap-4 ">
          {allResumes.map((resume, index) => {
            const baseColor = colors[index % colors.length]; // Access the color from the array
            return (
              <button
                key={index}
                ...
                style={{
                  background: `linear-gradient(135deg, ${baseColor}10, ${baseColor}40)`, // Apply color to background
                  borderColor: baseColor + "40", // Apply color to border
                }}
              >
                <FilePenLineIcon
